...
LF=$(printf '\\\012_')
LF=${LF%_}
EXTENSION_NAME=dataviewer
EXTENSION_ID=dataviewer
COLLABORATOR=Drdata
EXTENSION_DESCRIPTION="dataviewer Blocks."
...
sed -e "s|^export default \[$|import ${EXTENSION_ID}IconURL from './${EXTENSION_ID}/${EXTENSION_ID}.png';${LF}import ${EXTENSION_ID}InsetIconURL from './dataviewer/dataviewer-small.png';${LF}${LF}export default [${LF}${DESCRIPTION}|g" src/lib/libraries/extensions/index.jsx_orig > src/lib/libraries/extensions/index.jsx
